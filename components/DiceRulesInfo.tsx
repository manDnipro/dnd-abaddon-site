    ...
    <div style={{ marginBottom: 14 }}>
      ...
      {open && (
        <div style={{ marginTop: 8, padding: '10px 14px', background: '#0a0a0a', border: '1px solid #2a241c', borderRadius: 4 }}>
          ...
          <p style={{ color: '#999', fontSize: 12, lineHeight: 1.7, fontFamily: "'Special Elite', monospace", marginTop: 8 }}>
            🍀 <b style={{ color: '#c9a94f' }}>Удача</b> — окремий ресурс (до 3, оновлюється щодня): якщо ввімкнути перекид на вилазці,
            провалений кидок пошуку можна кинути ще раз за 1 очко удачі. Природна 1 на пошуку — завжди критичний
            провал, а на успішному пошуку в небезпечних локаціях є невеликий шанс "але щось тут не так" —
            невелике ускладнення навіть попри вдачу.
          </p>
        </div>
      )}
    </div>
