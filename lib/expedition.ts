...
export const LOOT_TIERS: Record<number, LootEntry[]> = {
  ...
  3: [
    ...
    { itemKey: 'energy_drink_1', minQuantity: 1, maxQuantity: 1, weight: 2 },
  ...
  4: [
    ...
    { itemKey: 'empty_flask', minQuantity: 1, maxQuantity: 1, weight: 2 },
    { itemKey: 'energy_drink_2', minQuantity: 1, maxQuantity: 1, weight: 2 },
    { itemKey: 'energy_drink_3', minQuantity: 1, maxQuantity: 1, weight: 1 },
